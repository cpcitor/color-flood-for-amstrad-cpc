...
#define grid_origin(row, col, bytes_per_cell_width, chars_height_per_cell_height) screen + row * char_stride * chars_height_per_cell_height + col * bytes_per_cell_width
